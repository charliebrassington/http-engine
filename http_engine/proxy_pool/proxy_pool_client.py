...
from http_engine.proxy_pool.interfaces import AbstractProxyPoolClient, AbstractProxyCollectorService, AbstractProxyQualityService
from http_engine.proxy_pool.models import CollectProxiesResponse
